...
Generated on: 2025-10-07T21:17:47.519715
"""
...
class MistieFunctionMember(BaseModel):
    ...
    mistie_function_hdr_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    trace_number: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
