...
Schema: OpenWorksCommonModel.FaultPlaneTrimesh
Generated on: 2025-10-07T21:17:47.499880
"""
...
class FaultPlaneTrimesh(BaseModel):
    """
    OpenWorksCommonModel.FaultPlaneTrimesh model.
    
    Represents data from the OpenWorksCommonModel.FaultPlaneTrimesh schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.FaultPlaneTrimesh"
    _schema_id = "#/definitions/OpenWorksCommonModel_FaultPlaneTrimesh"
    _sql_table_name = "OpenWorksCommonModel_FaultPlaneTrimesh"
    ...
    domain: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
