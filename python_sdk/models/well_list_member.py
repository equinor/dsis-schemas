...
Generated on: 2025-10-07T21:17:47.570229
"""
...
class WellListMember(BaseModel):
    """
    OpenWorksCommonModel.WellListMember model.
    
    Represents data from the OpenWorksCommonModel.WellListMember schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.WellListMember"
    _schema_id = "#/definitions/OpenWorksCommonModel_WellListMember"
    _sql_table_name = "OpenWorksCommonModel_WellListMember"
