...
Schema: OpenWorksCommonModel.ControlPoint
Generated on: 2025-10-07T21:17:47.492905
"""
...
class ControlPoint(BaseModel):
    """
    OpenWorksCommonModel.ControlPoint model.
    
    Represents data from the OpenWorksCommonModel.ControlPoint schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.ControlPoint"
    _schema_id = "#/definitions/OpenWorksCommonModel_ControlPoint"
    _sql_table_name = "OpenWorksCommonModel_ControlPoint"
    ...
    x_coord: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    y_coord: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
