...
Schema: OW5000.MudlogDesc
Generated on: 2025-10-08T21:10:50.339859
"""
...
class MudlogDesc(BaseModel):
    """
    OW5000.MudlogDesc model.
    
    Represents data from the OW5000.MudlogDesc schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.MudlogDesc"
    _schema_id = "#/definitions/OW5000_MudlogDesc"
    _sql_table_name = "OW5000_MudlogDesc"
    ...
    logger_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    description: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=240)
