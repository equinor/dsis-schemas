...
Generated on: 2025-10-08T21:10:50.127854
"""
...
class CrvBackup(BaseModel):
    ...
    seq: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
