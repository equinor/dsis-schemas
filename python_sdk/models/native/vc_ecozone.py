...
Generated on: 2025-10-08T21:10:50.487460
"""
...
class VcEcozone(BaseModel):
    ...
    # Model fields
    ecozone_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
