...
Generated on: 2025-10-08T21:10:50.352331
"""
...
class OwQuery(BaseModel):
    ...
    # Model fields
    query_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
