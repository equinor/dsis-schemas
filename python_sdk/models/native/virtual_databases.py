...
Generated on: 2025-10-08T21:10:50.529179
"""
...
class VirtualDatabases(BaseModel):
    ...
    Version: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=50)
