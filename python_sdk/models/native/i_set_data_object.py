...
Generated on: 2025-10-08T21:10:50.299323
"""
...
class ISetDataObject(BaseModel):
    ...
    data_key: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=1500)
