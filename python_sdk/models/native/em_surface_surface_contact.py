"""
EmSurfaceSurfaceContact Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.EmSurfaceSurfaceContact
Generated on: 2025-10-08T21:10:50.176783
"""
...
class EmSurfaceSurfaceContact(BaseModel):
    """
    OW5000.EmSurfaceSurfaceContact model.
    
    Represents data from the OW5000.EmSurfaceSurfaceContact schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.EmSurfaceSurfaceContact"
    _schema_id = "#/definitions/OW5000_EmSurfaceSurfaceContact"
    _sql_table_name = "OW5000_EmSurfaceSurfaceContact"
    
    # Model fields
    em_primary_horizon_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    em_secondary_horizon_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
