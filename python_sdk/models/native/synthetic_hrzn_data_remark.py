...
Generated on: 2025-10-08T21:10:50.481025
"""
...
class SyntheticHrznDataRemark(BaseModel):
    ...
    # Model fields
    syn_hrzn_data_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
