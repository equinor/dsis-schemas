"""
StructuralBody Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.StructuralBody
Generated on: 2025-10-08T21:10:50.475478
"""
...
class StructuralBody(BaseModel):
    """
    OW5000.StructuralBody model.
    
    Represents data from the OW5000.StructuralBody schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.StructuralBody"
    _schema_id = "#/definitions/OW5000_StructuralBody"
    _sql_table_name = "OW5000_StructuralBody"
    
    # Model fields
    structural_body_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
    structural_body_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=60)
    ...
    datum: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=1e-05)
