...
Generated on: 2025-10-08T21:10:50.445580
"""
...
class RSynHrznDataRmkType(BaseModel):
    ...
    # Model fields
    syn_hrzn_data_rmk_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    syn_hrzn_data_rmk_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
