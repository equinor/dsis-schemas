...
Schema: OW5000.I3DVAll
Generated on: 2025-10-08T21:10:50.287847
"""
...
class I3DVAll(BaseModel):
    """
    OW5000.I3DVAll model.
    
    Represents data from the OW5000.I3DVAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.I3DVAll"
    _schema_id = "#/definitions/OW5000_I3DVAll"
    _sql_table_name = "OW5000_I3DVAll"
    ...
    x_origin: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=1e-09)
    ...
    y_origin: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=1e-09)
