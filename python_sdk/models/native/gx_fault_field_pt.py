...
Generated on: 2025-10-08T21:10:50.275159
"""
...
class GxFaultFieldPt(BaseModel):
    ...
    # Model fields
    interp_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
