...
Generated on: 2025-10-08T21:10:50.513765
"""
...
class WellPlanningGroup(BaseModel):
    ...
    wp_group_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
