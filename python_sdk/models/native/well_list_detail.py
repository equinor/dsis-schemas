...
Generated on: 2025-10-08T21:10:50.503199
"""
...
class WellListDetail(BaseModel):
    ...
    # Model fields
    id_field: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')", alias="id")
