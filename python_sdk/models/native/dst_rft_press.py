...
Generated on: 2025-10-08T21:10:50.145980
"""
...
class DstRftPress(BaseModel):
    ...
    recorder_no: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=10)
