...
Generated on: 2025-10-08T21:10:50.128803
"""
...
class CrvSummationMember(BaseModel):
    ...
    # Model fields
    summation_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=25)
