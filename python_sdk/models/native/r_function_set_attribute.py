"""
RFunctionSetAttribute Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RFunctionSetAttribute
Generated on: 2025-10-08T21:10:50.409805
"""
...
class RFunctionSetAttribute(BaseModel):
    """
    OW5000.RFunctionSetAttribute model.
    
    Represents data from the OW5000.RFunctionSetAttribute schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RFunctionSetAttribute"
    _schema_id = "#/definitions/OW5000_RFunctionSetAttribute"
    _sql_table_name = "OW5000_RFunctionSetAttribute"
    ...
    function_set_attrib_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
