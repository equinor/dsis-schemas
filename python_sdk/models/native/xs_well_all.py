...
Generated on: 2025-10-08T21:10:50.523080
"""
...
class XsWellAll(BaseModel):
    ...
    tvd_val: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.01)
