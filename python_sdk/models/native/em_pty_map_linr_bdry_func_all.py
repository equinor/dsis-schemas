"""
EmPtyMapLinrBdryFuncAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.EmPtyMapLinrBdryFuncAll
Generated on: 2025-10-08T21:10:50.173693
"""
...
class EmPtyMapLinrBdryFuncAll(BaseModel):
    """
    OW5000.EmPtyMapLinrBdryFuncAll model.
    
    Represents data from the OW5000.EmPtyMapLinrBdryFuncAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.EmPtyMapLinrBdryFuncAll"
    _schema_id = "#/definitions/OW5000_EmPtyMapLinrBdryFuncAll"
    _sql_table_name = "OW5000_EmPtyMapLinrBdryFuncAll"
    
    # Model fields
    boundary_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    property_map_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    boundary_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=30)
