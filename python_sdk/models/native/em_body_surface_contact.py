...
Generated on: 2025-10-08T21:10:50.150348
"""
...
class EmBodySurfaceContact(BaseModel):
    ...
    # Model fields
    trimmed_surface_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
