...
Generated on: 2025-10-08T21:10:50.494888
"""
...
class WellAfe(BaseModel):
    ...
    # Model fields
    afe_no: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
