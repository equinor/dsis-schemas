"""
MappingPolygonAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.MappingPolygonAll
Generated on: 2025-10-08T21:10:50.332661
"""
...
class MappingPolygonAll(BaseModel):
    """
    OW5000.MappingPolygonAll model.
    
    Represents data from the OW5000.MappingPolygonAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.MappingPolygonAll"
    _schema_id = "#/definitions/OW5000_MappingPolygonAll"
    _sql_table_name = "OW5000_MappingPolygonAll"
    ...
    poly_seq_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    polygon_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
    ...
    poly_z_value_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    poly_z_value_dsdsunittype: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    ...
    throw_direction: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
