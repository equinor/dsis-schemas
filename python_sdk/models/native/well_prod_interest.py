"""
WellProdInterest Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellProdInterest
Generated on: 2025-10-08T21:10:50.514884
"""
...
class WellProdInterest(BaseModel):
    """
    OW5000.WellProdInterest model.
    
    Represents data from the OW5000.WellProdInterest schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.WellProdInterest"
    _schema_id = "#/definitions/OW5000_WellProdInterest"
    _sql_table_name = "OW5000_WellProdInterest"
    ...
    interest_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=24)
