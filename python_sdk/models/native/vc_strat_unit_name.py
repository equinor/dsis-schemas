"""
VcStratUnitName Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.VcStratUnitName
Generated on: 2025-10-08T21:10:50.489454
"""
...
class VcStratUnitName(BaseModel):
    """
    OW5000.VcStratUnitName model.
    
    Represents data from the OW5000.VcStratUnitName schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.VcStratUnitName"
    _schema_id = "#/definitions/OW5000_VcStratUnitName"
    _sql_table_name = "OW5000_VcStratUnitName"
    
    # Model fields
    strat_unit_name_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
