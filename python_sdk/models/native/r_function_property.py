"""
RFunctionProperty Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RFunctionProperty
Generated on: 2025-10-08T21:10:50.409334
"""
...
class RFunctionProperty(BaseModel):
    """
    OW5000.RFunctionProperty model.
    
    Represents data from the OW5000.RFunctionProperty schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RFunctionProperty"
    _schema_id = "#/definitions/OW5000_RFunctionProperty"
    _sql_table_name = "OW5000_RFunctionProperty"
    ...
    property_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
