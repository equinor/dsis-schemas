"""
FaultFaultContactAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.FaultFaultContactAll
Generated on: 2025-10-08T21:10:50.184872
"""
...
class FaultFaultContactAll(BaseModel):
    """
    OW5000.FaultFaultContactAll model.
    
    Represents data from the OW5000.FaultFaultContactAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.FaultFaultContactAll"
    _schema_id = "#/definitions/OW5000_FaultFaultContactAll"
    _sql_table_name = "OW5000_FaultFaultContactAll"
    ...
    secondary_fault_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    primary_fault_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
