"""
PrestackHorizonData Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.PrestackHorizonData
Generated on: 2025-10-08T21:10:50.388661
"""
...
class PrestackHorizonData(BaseModel):
    """
    OW5000.PrestackHorizonData model.
    
    Represents data from the OW5000.PrestackHorizonData schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.PrestackHorizonData"
    _schema_id = "#/definitions/OW5000_PrestackHorizonData"
    _sql_table_name = "OW5000_PrestackHorizonData"
    ...
    seismic_prestack_dataset_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    ...
    max_offset_traces: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    line_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    line_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    line_increment: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    trace_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    trace_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    trace_increment: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
