"""
RFractureProperty Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RFractureProperty
Generated on: 2025-10-08T21:10:50.407621
"""
...
class RFractureProperty(BaseModel):
    """
    OW5000.RFractureProperty model.
    
    Represents data from the OW5000.RFractureProperty schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RFractureProperty"
    _schema_id = "#/definitions/OW5000_RFractureProperty"
    _sql_table_name = "OW5000_RFractureProperty"
    ...
    fracture_property_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
