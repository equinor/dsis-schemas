...
Generated on: 2025-10-08T21:10:50.301236
"""
...
class ISetTemplateObjType(BaseModel):
    ...
    # Model fields
    iset_template_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
