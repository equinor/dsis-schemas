...
Generated on: 2025-10-08T21:10:50.266461
"""
...
class GgxSchemaVer(BaseModel):
    ...
    # Model fields
    sqlfile: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=80)
