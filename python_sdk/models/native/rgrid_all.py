...
Schema: OW5000.RgridAll
Generated on: 2025-10-08T21:10:50.463793
"""
...
class RgridAll(BaseModel):
    """
    OW5000.RgridAll model.
    
    Represents data from the OW5000.RgridAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RgridAll"
    _schema_id = "#/definitions/OW5000_RgridAll"
    _sql_table_name = "OW5000_RgridAll"
    ...
    z_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    z_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
