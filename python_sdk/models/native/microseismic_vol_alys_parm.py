...
Generated on: 2025-10-08T21:10:50.337055
"""
...
class MicroseismicVolAlysParm(BaseModel):
    ...
    parameter_value: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=1e-05)
