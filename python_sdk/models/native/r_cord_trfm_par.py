...
Generated on: 2025-10-08T21:10:50.400607
"""
...
class RCordTrfmPar(BaseModel):
    ...
    r_cord_trfm_par_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
