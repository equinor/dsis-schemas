...
Generated on: 2025-10-08T21:10:50.285119
"""
...
class HwcInterpControlPt(BaseModel):
    ...
    hwc_control_pt_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
