"""
PointSetCompositeAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.PointSetCompositeAll
Generated on: 2025-10-08T21:10:50.382099
"""
...
class PointSetCompositeAll(BaseModel):
    """
    OW5000.PointSetCompositeAll model.
    
    Represents data from the OW5000.PointSetCompositeAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.PointSetCompositeAll"
    _schema_id = "#/definitions/OW5000_PointSetCompositeAll"
    _sql_table_name = "OW5000_PointSetCompositeAll"
    ...
    num_point_set_fields: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
