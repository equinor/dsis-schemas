"""
LoggingToolParm Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.LoggingToolParm
Generated on: 2025-10-08T21:10:50.328168
"""
...
class LoggingToolParm(BaseModel):
    """
    OW5000.LoggingToolParm model.
    
    Represents data from the OW5000.LoggingToolParm schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.LoggingToolParm"
    _schema_id = "#/definitions/OW5000_LoggingToolParm"
    _sql_table_name = "OW5000_LoggingToolParm"
    ...
    tool_parm_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
