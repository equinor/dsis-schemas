...
Generated on: 2025-10-08T21:10:50.330017
"""
...
class MWDRun(BaseModel):
    ...
    mwd_run_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
