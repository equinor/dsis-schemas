...
Generated on: 2025-10-08T21:10:50.526834
"""
...
class Properties(BaseModel):
    ...
    Value: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=4000)
