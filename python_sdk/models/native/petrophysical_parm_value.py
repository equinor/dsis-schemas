"""
PetrophysicalParmValue Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.PetrophysicalParmValue
Generated on: 2025-10-08T21:10:50.373826
"""
...
class PetrophysicalParmValue(BaseModel):
    """
    OW5000.PetrophysicalParmValue model.
    
    Represents data from the OW5000.PetrophysicalParmValue schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.PetrophysicalParmValue"
    _schema_id = "#/definitions/OW5000_PetrophysicalParmValue"
    _sql_table_name = "OW5000_PetrophysicalParmValue"
    
    # Model fields
    petro_parm_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
    petro_parm_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    ...
    parm_relatn_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=30)
    parm_source: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=24)
