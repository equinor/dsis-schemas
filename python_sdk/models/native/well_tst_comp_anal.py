...
Generated on: 2025-10-08T21:10:50.521281
"""
...
class WellTstCompAnal(BaseModel):
    ...
    report_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
