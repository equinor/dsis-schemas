"""
RInterpretationVersion Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RInterpretationVersion
Generated on: 2025-10-08T21:10:50.417286
"""
...
class RInterpretationVersion(BaseModel):
    """
    OW5000.RInterpretationVersion model.
    
    Represents data from the OW5000.RInterpretationVersion schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RInterpretationVersion"
    _schema_id = "#/definitions/OW5000_RInterpretationVersion"
    _sql_table_name = "OW5000_RInterpretationVersion"
    ...
    interpretation_version_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
