...
Schema: OW5000.DailyActivity
Generated on: 2025-10-08T21:10:50.132983
"""
...
class DailyActivity(BaseModel):
    """
    OW5000.DailyActivity model.
    
    Represents data from the OW5000.DailyActivity schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.DailyActivity"
    _schema_id = "#/definitions/OW5000_DailyActivity"
    _sql_table_name = "OW5000_DailyActivity"
    ...
    time_spent: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    time_spent_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
