...
Generated on: 2025-10-08T21:10:50.420663
"""
...
class RMicroseismicEventPty(BaseModel):
    ...
    microseis_event_pty_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
