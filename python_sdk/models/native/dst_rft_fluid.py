...
Generated on: 2025-10-08T21:10:50.144046
"""
...
class DstRftFluid(BaseModel):
    ...
    fluid_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
