...
Generated on: 2025-10-08T21:10:50.484823
"""
...
class ToolCoefficient(BaseModel):
    ...
    coeff_obs_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
