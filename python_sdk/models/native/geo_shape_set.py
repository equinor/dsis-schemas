...
Schema: OW5000.GeoShapeSet
Generated on: 2025-10-08T21:10:50.255575
"""
...
class GeoShapeSet(BaseModel):
    """
    OW5000.GeoShapeSet model.
    
    Represents data from the OW5000.GeoShapeSet schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.GeoShapeSet"
    _schema_id = "#/definitions/OW5000_GeoShapeSet"
    _sql_table_name = "OW5000_GeoShapeSet"
    
    # Model fields
    shape_set_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    ...
    nodes: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
    nodes_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    nodes_dsdsunittype: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    ...
    shapes: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
