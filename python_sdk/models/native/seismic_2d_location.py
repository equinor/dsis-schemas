"""
Seismic2DLocation Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.Seismic2DLocation
Generated on: 2025-10-08T21:10:50.467631
"""
...
class Seismic2DLocation(BaseModel):
    """
    OW5000.Seismic2DLocation model.
    
    Represents data from the OW5000.Seismic2DLocation schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.Seismic2DLocation"
    _schema_id = "#/definitions/OW5000_Seismic2DLocation"
    _sql_table_name = "OW5000_Seismic2DLocation"
    ...
    max_trace_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
