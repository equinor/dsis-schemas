...
Generated on: 2025-10-08T21:10:50.429844
"""
...
class RPrestackHrznHdrRmkType(BaseModel):
    ...
    prestack_hrzn_hdr_rmk_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
