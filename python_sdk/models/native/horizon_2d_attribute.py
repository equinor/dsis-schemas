...
Generated on: 2025-10-08T21:10:50.276874
"""
...
class Horizon2DAttribute(BaseModel):
    ...
    start_trace: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
