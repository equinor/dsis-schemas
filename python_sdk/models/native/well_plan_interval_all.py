"""
WellPlanIntervalAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellPlanIntervalAll
Generated on: 2025-10-08T21:10:50.513166
"""
...
class WellPlanIntervalAll(BaseModel):
    """
    OW5000.WellPlanIntervalAll model.
    
    Represents data from the OW5000.WellPlanIntervalAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.WellPlanIntervalAll"
    _schema_id = "#/definitions/OW5000_WellPlanIntervalAll"
    _sql_table_name = "OW5000_WellPlanIntervalAll"
    ...
    interval_text: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=512)
