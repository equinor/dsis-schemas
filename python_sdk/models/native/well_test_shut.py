...
Schema: OW5000.WellTestShut
Generated on: 2025-10-08T21:10:50.520583
"""
...
class WellTestShut(BaseModel):
    """
    OW5000.WellTestShut model.
    
    Represents data from the OW5000.WellTestShut schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.WellTestShut"
    _schema_id = "#/definitions/OW5000_WellTestShut"
    _sql_table_name = "OW5000_WellTestShut"
    ...
    shutoff_obs_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    shutoff_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    ...
    plugback_depth: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.01)
    plugback_depth_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
