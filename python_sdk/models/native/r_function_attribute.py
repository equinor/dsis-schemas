"""
RFunctionAttribute Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RFunctionAttribute
Generated on: 2025-10-08T21:10:50.408933
"""
...
class RFunctionAttribute(BaseModel):
    """
    OW5000.RFunctionAttribute model.
    
    Represents data from the OW5000.RFunctionAttribute schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RFunctionAttribute"
    _schema_id = "#/definitions/OW5000_RFunctionAttribute"
    _sql_table_name = "OW5000_RFunctionAttribute"
    ...
    function_attrib_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
