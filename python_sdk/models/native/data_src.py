...
Generated on: 2025-10-08T21:10:50.134411
"""
...
class DataSrc(BaseModel):
    ...
    # Model fields
    id_field: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=5, alias="id")
