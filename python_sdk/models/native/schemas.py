...
Schema: SYS.Schemas
Generated on: 2025-10-08T21:10:50.528295
"""
...
class Schemas(BaseModel):
    ...
    IsPhysical: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    PrimaryMetamodelURI: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=255)
