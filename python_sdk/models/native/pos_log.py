...
Generated on: 2025-10-08T21:10:50.386438
"""
...
class PosLog(BaseModel):
    ...
    bh_z_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
