...
Generated on: 2025-10-08T21:10:50.124644
"""
...
class CorePropertyAlysDetail(BaseModel):
    ...
    alys_detail_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
