...
Generated on: 2025-10-08T21:10:50.464918
"""
...
class Seis2DStorageArea(BaseModel):
    ...
    seis_2d_storage_area_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
