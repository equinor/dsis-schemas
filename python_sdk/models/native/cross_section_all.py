"""
CrossSectionAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.CrossSectionAll
Generated on: 2025-10-08T21:10:50.127389
"""
...
class CrossSectionAll(BaseModel):
    """
    OW5000.CrossSectionAll model.
    
    Represents data from the OW5000.CrossSectionAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.CrossSectionAll"
    _schema_id = "#/definitions/OW5000_CrossSectionAll"
    _sql_table_name = "OW5000_CrossSectionAll"
    ...
    xsec_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
