...
Schema: OW5000.REmProperty
Generated on: 2025-10-08T21:10:50.405464
"""
...
class REmProperty(BaseModel):
    """
    OW5000.REmProperty model.
    
    Represents data from the OW5000.REmProperty schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.REmProperty"
    _schema_id = "#/definitions/OW5000_REmProperty"
    _sql_table_name = "OW5000_REmProperty"
    ...
    em_property_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
