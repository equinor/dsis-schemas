...
Schema: OW5000.RDataType
Generated on: 2025-10-08T21:10:50.403027
"""
...
class RDataType(BaseModel):
    """
    OW5000.RDataType model.
    
    Represents data from the OW5000.RDataType schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RDataType"
    _schema_id = "#/definitions/OW5000_RDataType"
    _sql_table_name = "OW5000_RDataType"
    ...
    data_type_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
