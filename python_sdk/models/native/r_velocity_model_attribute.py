"""
RVelocityModelAttribute Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RVelocityModelAttribute
Generated on: 2025-10-08T21:10:50.452784
"""
...
class RVelocityModelAttribute(BaseModel):
    """
    OW5000.RVelocityModelAttribute model.
    
    Represents data from the OW5000.RVelocityModelAttribute schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RVelocityModelAttribute"
    _schema_id = "#/definitions/OW5000_RVelocityModelAttribute"
    _sql_table_name = "OW5000_RVelocityModelAttribute"
    ...
    velocity_model_attrib_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
