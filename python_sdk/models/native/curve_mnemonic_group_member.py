...
Generated on: 2025-10-08T21:10:50.131043
"""
...
class CurveMnemonicGroupMember(BaseModel):
    ...
    # Model fields
    crv_group_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=25)
