"""
FaultSurfaceContactAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.FaultSurfaceContactAll
Generated on: 2025-10-08T21:10:50.230687
"""
...
class FaultSurfaceContactAll(BaseModel):
    """
    OW5000.FaultSurfaceContactAll model.
    
    Represents data from the OW5000.FaultSurfaceContactAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.FaultSurfaceContactAll"
    _schema_id = "#/definitions/OW5000_FaultSurfaceContactAll"
    _sql_table_name = "OW5000_FaultSurfaceContactAll"
    ...
    fault_network_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
