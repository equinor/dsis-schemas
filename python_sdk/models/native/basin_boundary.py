...
Schema: OW5000.BasinBoundary
Generated on: 2025-10-08T21:10:50.102805
"""
...
class BasinBoundary(BaseModel):
    """
    OW5000.BasinBoundary model.
    
    Represents data from the OW5000.BasinBoundary schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.BasinBoundary"
    _schema_id = "#/definitions/OW5000_BasinBoundary"
    _sql_table_name = "OW5000_BasinBoundary"
    ...
    polygon_id: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    point_seq: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
