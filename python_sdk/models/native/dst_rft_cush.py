...
Generated on: 2025-10-08T21:10:50.139750
"""
...
class DstRftCush(BaseModel):
    ...
    cush_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
