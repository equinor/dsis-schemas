"""
RShapeAttribute Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.RShapeAttribute
Generated on: 2025-10-08T21:10:50.438126
"""
...
class RShapeAttribute(BaseModel):
    """
    OW5000.RShapeAttribute model.
    
    Represents data from the OW5000.RShapeAttribute schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.RShapeAttribute"
    _schema_id = "#/definitions/OW5000_RShapeAttribute"
    _sql_table_name = "OW5000_RShapeAttribute"
    ...
    shape_attrib_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
