...
Generated on: 2025-10-08T21:10:50.321613
"""
...
class LogImageUnregImage(BaseModel):
    ...
    tif_file_path: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=255)
