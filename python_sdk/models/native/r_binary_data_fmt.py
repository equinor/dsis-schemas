...
Generated on: 2025-10-08T21:10:50.398220
"""
...
class RBinaryDataFmt(BaseModel):
    ...
    binary_data_format_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
