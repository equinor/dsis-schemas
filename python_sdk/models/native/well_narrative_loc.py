...
Generated on: 2025-10-08T21:10:50.505371
"""
...
class WellNarrativeLoc(BaseModel):
    ...
    narr_loc_seq_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
