...
Generated on: 2025-10-08T21:10:50.307266
"""
...
class InterpretationSet(BaseModel):
    ...
    interpret_set_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
