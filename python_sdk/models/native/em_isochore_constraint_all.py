"""
EmIsochoreConstraintAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.EmIsochoreConstraintAll
Generated on: 2025-10-08T21:10:50.166132
"""
...
class EmIsochoreConstraintAll(BaseModel):
    """
    OW5000.EmIsochoreConstraintAll model.
    
    Represents data from the OW5000.EmIsochoreConstraintAll schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.EmIsochoreConstraintAll"
    _schema_id = "#/definitions/OW5000_EmIsochoreConstraintAll"
    _sql_table_name = "OW5000_EmIsochoreConstraintAll"
    
    # Model fields
    isochore_constraint_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    ...
    constraining_horizon_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    constrained_horizon_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
