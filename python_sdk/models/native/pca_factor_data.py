...
Schema: OW5000.PcaFactorData
Generated on: 2025-10-08T21:10:50.360685
"""
...
class PcaFactorData(BaseModel):
    """
    OW5000.PcaFactorData model.
    
    Represents data from the OW5000.PcaFactorData schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.PcaFactorData"
    _schema_id = "#/definitions/OW5000_PcaFactorData"
    _sql_table_name = "OW5000_PcaFactorData"
    ...
    factor_data_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
