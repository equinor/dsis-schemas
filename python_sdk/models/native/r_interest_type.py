...
Generated on: 2025-10-08T21:10:50.415839
"""
...
class RInterestType(BaseModel):
    ...
    # Model fields
    interest_type_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
