"""
WellInterestScale Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellInterestScale
Generated on: 2025-10-08T21:10:50.501926
"""
...
class WellInterestScale(BaseModel):
    """
    OW5000.WellInterestScale model.
    
    Represents data from the OW5000.WellInterestScale schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.WellInterestScale"
    _schema_id = "#/definitions/OW5000_WellInterestScale"
    _sql_table_name = "OW5000_WellInterestScale"
    ...
    scale_obs_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
