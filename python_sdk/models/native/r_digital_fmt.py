...
Generated on: 2025-10-08T21:10:50.403347
"""
...
class RDigitalFmt(BaseModel):
    ...
    r_digital_fmt_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
