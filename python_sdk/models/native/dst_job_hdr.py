...
Schema: OW5000.DstJobHdr
Generated on: 2025-10-08T21:10:50.139422
"""
...
class DstJobHdr(BaseModel):
    """
    OW5000.DstJobHdr model.
    
    Represents data from the OW5000.DstJobHdr schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.DstJobHdr"
    _schema_id = "#/definitions/OW5000_DstJobHdr"
    _sql_table_name = "OW5000_DstJobHdr"
    ...
    dst_test_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    total_cost_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
