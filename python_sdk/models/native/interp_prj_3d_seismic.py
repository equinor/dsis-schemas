...
Generated on: 2025-10-08T21:10:50.303369
"""
...
class InterpPrj3DSeismic(BaseModel):
    ...
    seismic_3d_survey_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
