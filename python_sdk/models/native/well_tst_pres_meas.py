"""
WellTstPresMeas Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellTstPresMeas
Generated on: 2025-10-08T21:10:50.521719
"""
...
class WellTstPresMeas(BaseModel):
    """
    OW5000.WellTstPresMeas model.
    
    Represents data from the OW5000.WellTstPresMeas schema.
    """
    
    # Schema metadata
    _schema_title = "OW5000.WellTstPresMeas"
    _schema_id = "#/definitions/OW5000_WellTstPresMeas"
    _sql_table_name = "OW5000_WellTstPresMeas"
    ...
    measurement_obs_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    measurement_temp: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    measurement_temp_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
