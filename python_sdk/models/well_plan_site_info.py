...
Generated on: 2025-10-07T21:17:47.574621
"""
...
class WellPlanSiteInfo(BaseModel):
    ...
    type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=50)
