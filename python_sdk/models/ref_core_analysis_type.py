...
Generated on: 2025-10-07T21:17:47.540802
"""
...
class RefCoreAnalysisType(BaseModel):
    ...
    # Model fields
    core_analysis_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
