"""
IrregularGeometryPoints Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OpenWorksCommonModel.IrregularGeometryPoints
Generated on: 2025-10-07T21:17:47.513064
"""
...
class IrregularGeometryPoints(BaseModel):
    """
    OpenWorksCommonModel.IrregularGeometryPoints model.
    
    Represents data from the OpenWorksCommonModel.IrregularGeometryPoints schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.IrregularGeometryPoints"
    _schema_id = "#/definitions/OpenWorksCommonModel_IrregularGeometryPoints"
    _sql_table_name = "OpenWorksCommonModel_IrregularGeometryPoints"
    ...
    target_point_seq_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
