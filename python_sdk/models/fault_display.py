...
Generated on: 2025-10-07T21:17:47.498271
"""
...
class FaultDisplay(BaseModel):
    """
    OpenWorksCommonModel.FaultDisplay model.
    
    Represents data from the OpenWorksCommonModel.FaultDisplay schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.FaultDisplay"
    _schema_id = "#/definitions/OpenWorksCommonModel_FaultDisplay"
    _sql_table_name = "OpenWorksCommonModel_FaultDisplay"
    ...
    display_ind: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
