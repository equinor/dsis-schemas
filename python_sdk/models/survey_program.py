...
Generated on: 2025-10-07T21:17:47.557823
"""
...
class SurveyProgram(BaseModel):
    ...
    directionalsurvey_native_uid: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=1024)
