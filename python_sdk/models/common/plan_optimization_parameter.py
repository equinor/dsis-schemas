"""
PlanOptimizationParameter Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OpenWorksCommonModel.PlanOptimizationParameter
Generated on: 2025-10-08T21:03:38.774369
"""
...
class PlanOptimizationParameter(BaseModel):
    """
    OpenWorksCommonModel.PlanOptimizationParameter model.
    
    Represents data from the OpenWorksCommonModel.PlanOptimizationParameter schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.PlanOptimizationParameter"
    _schema_id = "#/definitions/OpenWorksCommonModel_PlanOptimizationParameter"
    _sql_table_name = "OpenWorksCommonModel_PlanOptimizationParameter"
    ...
    parameter_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    ...
    parameter_value_unit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
