...
Generated on: 2025-10-08T21:03:38.788285
"""
...
class RefStratigraphicUnitName(BaseModel):
    ...
    # Model fields
    strat_unit_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
