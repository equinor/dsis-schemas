"""
WellPlanInterval Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OpenWorksCommonModel.WellPlanInterval
Generated on: 2025-10-08T21:03:38.844262
"""
...
class WellPlanInterval(BaseModel):
    """
    OpenWorksCommonModel.WellPlanInterval model.
    
    Represents data from the OpenWorksCommonModel.WellPlanInterval schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.WellPlanInterval"
    _schema_id = "#/definitions/OpenWorksCommonModel_WellPlanInterval"
    _sql_table_name = "OpenWorksCommonModel_WellPlanInterval"
    ...
    wellplan_native_uid: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=1024)
    ...
    interval_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
    occurrence_no: Optional[int] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    interval_text: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=256)
