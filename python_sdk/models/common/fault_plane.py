...
Schema: OpenWorksCommonModel.FaultPlane
Generated on: 2025-10-08T21:03:38.749460
"""
...
class FaultPlane(BaseModel):
    """
    OpenWorksCommonModel.FaultPlane model.
    
    Represents data from the OpenWorksCommonModel.FaultPlane schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.FaultPlane"
    _schema_id = "#/definitions/OpenWorksCommonModel_FaultPlane"
    _sql_table_name = "OpenWorksCommonModel_FaultPlane"
