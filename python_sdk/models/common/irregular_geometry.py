"""
IrregularGeometry Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OpenWorksCommonModel.IrregularGeometry
Generated on: 2025-10-08T21:03:38.762888
"""
...
class IrregularGeometry(BaseModel):
    """
    OpenWorksCommonModel.IrregularGeometry model.
    
    Represents data from the OpenWorksCommonModel.IrregularGeometry schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.IrregularGeometry"
    _schema_id = "#/definitions/OpenWorksCommonModel_IrregularGeometry"
    _sql_table_name = "OpenWorksCommonModel_IrregularGeometry"
    ...
    target_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=50)
    ...
    offset_x: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    offset_y: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    ...
    up_distance: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    down_distance: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    dip_angle: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
