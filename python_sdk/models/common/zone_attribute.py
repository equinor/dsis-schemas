...
Schema: OpenWorksCommonModel.ZoneAttribute
Generated on: 2025-10-08T21:03:38.852135
"""
...
class ZoneAttribute(BaseModel):
    """
    OpenWorksCommonModel.ZoneAttribute model.
    
    Represents data from the OpenWorksCommonModel.ZoneAttribute schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.ZoneAttribute"
    _schema_id = "#/definitions/OpenWorksCommonModel_ZoneAttribute"
    _sql_table_name = "OpenWorksCommonModel_ZoneAttribute"
    ...
    unit_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    ...
    value_: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
