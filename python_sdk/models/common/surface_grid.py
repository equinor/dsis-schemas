...
Generated on: 2025-10-08T21:03:38.824799
"""
...
class SurfaceGrid(BaseModel):
    """
    OpenWorksCommonModel.SurfaceGrid model.
    
    Represents data from the OpenWorksCommonModel.SurfaceGrid schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.SurfaceGrid"
    _schema_id = "#/definitions/OpenWorksCommonModel_SurfaceGrid"
    _sql_table_name = "OpenWorksCommonModel_SurfaceGrid"
    ...
    grid_interval_x: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    grid_interval_y: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
    ...
    rotation_i: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    ...
    rotation_origin_x: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
    rotation_origin_y: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.0001)
