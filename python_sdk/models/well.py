...
Generated on: 2025-10-07T21:17:47.563211
"""
...
class Well(BaseModel):
    """
    OpenWorksCommonModel.Well model.
    
    Represents data from the OpenWorksCommonModel.Well schema.
    """
    
    # Schema metadata
    _schema_title = "OpenWorksCommonModel.Well"
    _schema_id = "#/definitions/OpenWorksCommonModel_Well"
    _sql_table_name = "OpenWorksCommonModel_Well"
    ...
    alternate_well_name: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=100)
    well_geometry_type: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
    ...
    governmental_area: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=15)
    ...
    well_net_interest: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')", multiple_of=0.001)
