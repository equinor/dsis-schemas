...
class RefHorizonAttribute(BaseModel):
    """
    OpenWorksCommonModel.RefHorizonAttribute model.

    Represents data from the OpenWorksCommonModel.RefHorizonAttribute schema.
    """

    # Schema metadata
    _schema_title = "OpenWorksCommonModel.RefHorizonAttribute"
    _schema_id = "#/definitions/OpenWorksCommonModel_RefHorizonAttribute"
    _sql_table_name = "OpenWorksCommonModel_RefHorizonAttribute"
    ...
    horizon_attribute_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
    ...
    prestack_header_entry: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=8)
    ...
    unit_type: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
