...
Generated on: 2026-04-17T09:03:28.245736
"""
...
class MistieFunctionMember(BaseModel):
    ...
    trace_number: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    mistie_value: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
