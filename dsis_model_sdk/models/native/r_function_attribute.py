...
Generated on: 2026-04-17T09:03:28.858510
"""
...
class RFunctionAttribute(BaseModel):
    ...
    function_attrib_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
