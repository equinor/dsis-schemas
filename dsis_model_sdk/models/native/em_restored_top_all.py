"""
EmRestoredTopAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.EmRestoredTopAll
Generated on: 2026-04-17T09:03:28.523422
"""
...
class EmRestoredTopAll(BaseModel):
    """
    OW5000.EmRestoredTopAll model.

    Represents data from the OW5000.EmRestoredTopAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.EmRestoredTopAll"
    _schema_id = "#/definitions/OW5000_EmRestoredTopAll"
    _sql_table_name = "OW5000_EmRestoredTopAll"
    ...
    point_x: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    point_y: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    point_z: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
