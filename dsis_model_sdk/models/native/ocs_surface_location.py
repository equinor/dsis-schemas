"""
OcsSurfaceLocation Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.OcsSurfaceLocation
Generated on: 2026-04-17T09:03:28.764899
"""
...
class OcsSurfaceLocation(BaseModel):
    """
    OW5000.OcsSurfaceLocation model.

    Represents data from the OW5000.OcsSurfaceLocation schema.
    """

    # Schema metadata
    _schema_title = "OW5000.OcsSurfaceLocation"
    _schema_id = "#/definitions/OW5000_OcsSurfaceLocation"
    _sql_table_name = "OW5000_OcsSurfaceLocation"
    ...
    utm_quad: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=7)
    state_fed: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=1)
