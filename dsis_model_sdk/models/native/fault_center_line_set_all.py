"""
FaultCenterLineSetAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.FaultCenterLineSetAll
Generated on: 2026-04-17T09:03:28.539468
"""
...
class FaultCenterLineSetAll(BaseModel):
    """
    OW5000.FaultCenterLineSetAll model.

    Represents data from the OW5000.FaultCenterLineSetAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.FaultCenterLineSetAll"
    _schema_id = "#/definitions/OW5000_FaultCenterLineSetAll"
    _sql_table_name = "OW5000_FaultCenterLineSetAll"

    # Model fields
    fault_set_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
    pick_surf: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=255)
    centerline_set_name: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
