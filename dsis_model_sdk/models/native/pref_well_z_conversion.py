"""
PrefWellZConversion Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.PrefWellZConversion
...
class PrefWellZConversion(BaseModel):
    """
    OW5000.PrefWellZConversion model.

    Represents data from the OW5000.PrefWellZConversion schema.
    """

    # Schema metadata
    _schema_title = "OW5000.PrefWellZConversion"
    _schema_id = "#/definitions/OW5000_PrefWellZConversion"
    _sql_table_name = "OW5000_PrefWellZConversion"
    ...
    depth_depth_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
