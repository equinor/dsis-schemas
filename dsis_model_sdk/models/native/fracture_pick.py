...
Schema: OW5000.FracturePick
Generated on: 2026-04-17T09:03:28.608840
"""
...
class FracturePick(BaseModel):
    """
    OW5000.FracturePick model.

    Represents data from the OW5000.FracturePick schema.
    """

    # Schema metadata
    _schema_title = "OW5000.FracturePick"
    _schema_id = "#/definitions/OW5000_FracturePick"
    _sql_table_name = "OW5000_FracturePick"
    ...
    pick_depth: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
