...
Schema: OW5000.Fault
Generated on: 2026-04-17T09:03:28.534956
"""
...
class Fault(BaseModel):
    ...
    heave_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    vert_sep_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
