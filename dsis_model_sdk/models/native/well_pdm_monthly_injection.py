"""
WellPdmMonthlyInjection Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellPdmMonthlyInjection
Generated on: 2026-04-17T09:03:29.113579
"""
...
class WellPdmMonthlyInjection(BaseModel):
    """
    OW5000.WellPdmMonthlyInjection model.

    Represents data from the OW5000.WellPdmMonthlyInjection schema.
    """

    # Schema metadata
    _schema_title = "OW5000.WellPdmMonthlyInjection"
    _schema_id = "#/definitions/OW5000_WellPdmMonthlyInjection"
    _sql_table_name = "OW5000_WellPdmMonthlyInjection"
    ...
    pr_tub_inj_avg: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    pr_tub_inj_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    pr_tub_inj_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    pr_cas_inj_avg: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    pr_cas_inj_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    pr_cas_inj_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
