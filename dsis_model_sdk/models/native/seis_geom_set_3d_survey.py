"""
SeisGeomSet3DSurvey Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.SeisGeomSet3DSurvey
Generated on: 2026-04-17T09:03:28.969755
"""
...
class SeisGeomSet3DSurvey(BaseModel):
    """
    OW5000.SeisGeomSet3DSurvey model.

    Represents data from the OW5000.SeisGeomSet3DSurvey schema.
    """

    # Schema metadata
    _schema_title = "OW5000.SeisGeomSet3DSurvey"
    _schema_id = "#/definitions/OW5000_SeisGeomSet3DSurvey"
    _sql_table_name = "OW5000_SeisGeomSet3DSurvey"
    ...
    acq_cost: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    azm_surfloc_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
