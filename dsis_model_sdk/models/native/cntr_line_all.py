...
Generated on: 2026-04-17T09:03:28.433807
"""
...
class CntrLineAll(BaseModel):
    ...
    cntr_line_value_dsdsunit: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
