...
Generated on: 2026-04-17T09:03:29.025858
"""
...
class ThumbNail(BaseModel):
    ...
    # Model fields
    thumb_nail_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    thumb_nail_type: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
