...
Schema: OW5000.CntrSet
Generated on: 2026-04-17T09:03:28.436320
"""
...
class CntrSet(BaseModel):
    """
    OW5000.CntrSet model.

    Represents data from the OW5000.CntrSet schema.
    """

    # Schema metadata
    _schema_title = "OW5000.CntrSet"
    _schema_id = "#/definitions/OW5000_CntrSet"
    _sql_table_name = "OW5000_CntrSet"
    ...
    cntr_interval: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    cntr_min: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    cntr_max: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    cntr_width: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
