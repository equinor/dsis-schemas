"""
ProcedureParams Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: SYS.ProcedureParams
...
class ProcedureParams(BaseModel):
    """
    SYS.ProcedureParams model.

    Represents data from the SYS.ProcedureParams schema.
    """

    # Schema metadata
    _schema_title = "SYS.ProcedureParams"
    _schema_id = "#/definitions/SYS_ProcedureParams"
    _sql_table_name = "SYS_ProcedureParams"
    ...
    ProcedureName: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=255)
    ProcedureUID: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=50)
    ...
    Optional_field: int = Field(description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')", alias="Optional")
    ...
    DefaultValue: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=255)
