...
Schema: OW5000.Seis2DLine
Generated on: 2026-04-17T09:03:28.966689
"""
...
class Seis2DLine(BaseModel):
    """
    OW5000.Seis2DLine model.

    Represents data from the OW5000.Seis2DLine schema.
    """

    # Schema metadata
    _schema_title = "OW5000.Seis2DLine"
    _schema_id = "#/definitions/OW5000_Seis2DLine"
    _sql_table_name = "OW5000_Seis2DLine"
    ...
    orig_shotpoints_crs_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
