...
class XSecAnnoAll(BaseModel):
    """
    OW5000.XSecAnnoAll model.

    Represents data from the OW5000.XSecAnnoAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.XSecAnnoAll"
    _schema_id = "#/definitions/OW5000_XSecAnnoAll"
    _sql_table_name = "OW5000_XSecAnnoAll"
    ...
    x_sec_anno_height: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    x_sec_anno_angle: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    x_sec_anno_distance: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    x_sec_anno_z: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
