"""
FaultCenterLineAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.FaultCenterLineAll
Generated on: 2026-04-17T09:03:28.537469
"""
...
class FaultCenterLineAll(BaseModel):
    """
    OW5000.FaultCenterLineAll model.

    Represents data from the OW5000.FaultCenterLineAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.FaultCenterLineAll"
    _schema_id = "#/definitions/OW5000_FaultCenterLineAll"
    _sql_table_name = "OW5000_FaultCenterLineAll"

    # Model fields
    fault_set_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=3)
    ...
    vertical_separation: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
    vertical_separation_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    vertical_separation_dsdsunittype: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    dip_angle: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
    ...
    heave: Optional[bytes] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('BINARY', 'BLOB', 'LONGVARBINARY', 'VARBINARY')", max_length=8)
