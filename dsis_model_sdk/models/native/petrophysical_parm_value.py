...
Generated on: 2026-04-17T09:03:28.797500
"""
...
class PetrophysicalParmValue(BaseModel):
    ...
    petro_parm_name: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    ...
    well_list_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    ...
    effective_date: datetime = Field(description="SQL Type: DBAPITYPEOBJECT('TIMESTAMP')")
