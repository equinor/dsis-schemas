...
Schema: OW5000.TurnPointAll
Generated on: 2026-04-17T09:03:29.030857
"""
...
class TurnPointAll(BaseModel):
    """
    OW5000.TurnPointAll model.

    Represents data from the OW5000.TurnPointAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.TurnPointAll"
    _schema_id = "#/definitions/OW5000_TurnPointAll"
    _sql_table_name = "OW5000_TurnPointAll"
    ...
    inclination_angle: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    tool_face: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    z: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
