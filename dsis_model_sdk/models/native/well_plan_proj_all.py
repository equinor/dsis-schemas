"""
WellPlanProjAll Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellPlanProjAll
Generated on: 2026-04-17T09:03:29.124679
"""
...
class WellPlanProjAll(BaseModel):
    """
    OW5000.WellPlanProjAll model.

    Represents data from the OW5000.WellPlanProjAll schema.
    """

    # Schema metadata
    _schema_title = "OW5000.WellPlanProjAll"
    _schema_id = "#/definitions/OW5000_WellPlanProjAll"
    _sql_table_name = "OW5000_WellPlanProjAll"

    # Model fields
    wp_project_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
    wp_project_name: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    wp_group_id: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
