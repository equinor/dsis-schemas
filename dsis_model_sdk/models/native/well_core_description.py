"""
WellCoreDescription Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.WellCoreDescription
Generated on: 2026-04-17T09:03:29.071799
"""
...
class WellCoreDescription(BaseModel):
    """
    OW5000.WellCoreDescription model.

    Represents data from the OW5000.WellCoreDescription schema.
    """

    # Schema metadata
    _schema_title = "OW5000.WellCoreDescription"
    _schema_id = "#/definitions/OW5000_WellCoreDescription"
    _sql_table_name = "OW5000_WellCoreDescription"
    ...
    description_obs_no: int = Field(description="SQL Type: DBAPITYPEOBJECT('BOOLEAN', 'BIGINT', 'BIT', 'INTEGER', 'SMALLINT', 'TINYINT')")
    ...
    interval_thickness: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    interval_thickness_dsdsunit: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=64)
    ...
    show_length: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    core_description_company: Optional[str] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=40)
    porosity_length: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    description_date: Optional[datetime] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('TIMESTAMP')")
