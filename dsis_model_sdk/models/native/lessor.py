...
Generated on: 2026-04-17T09:03:28.710827
"""
...
class Lessor(BaseModel):
    ...
    percent_ownership: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    ...
    mineral_interest: Optional[float] = Field(default=None, description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
