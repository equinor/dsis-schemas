...
Generated on: 2026-04-17T09:03:28.656532
"""
...
class HorizonChangeLog(BaseModel):
    ...
    min_line: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
    max_line: float = Field(description="SQL Type: DBAPITYPEOBJECT('FLOAT', 'REAL', 'DOUBLE')")
