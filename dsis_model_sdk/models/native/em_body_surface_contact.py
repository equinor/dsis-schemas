"""
EmBodySurfaceContact Model

Auto-generated from OpenWorks Common Model JSON Schema.
Schema: OW5000.EmBodySurfaceContact
Generated on: 2026-04-17T09:03:28.482983
"""
...
class EmBodySurfaceContact(BaseModel):
    """
    OW5000.EmBodySurfaceContact model.

    Represents data from the OW5000.EmBodySurfaceContact schema.
    """

    # Schema metadata
    _schema_title = "OW5000.EmBodySurfaceContact"
    _schema_id = "#/definitions/OW5000_EmBodySurfaceContact"
    _sql_table_name = "OW5000_EmBodySurfaceContact"

    # Model fields
    trimmed_surface_id: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=12)
