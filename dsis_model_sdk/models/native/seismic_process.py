...
Generated on: 2026-04-17T09:03:28.983042
"""
...
class SeismicProcess(BaseModel):
    ...
    seismic_process_type: str = Field(description="SQL Type: DBAPITYPEOBJECT('CHAR', 'NCHAR', 'NVARCHAR', 'VARCHAR', 'OTHER')", max_length=20)
